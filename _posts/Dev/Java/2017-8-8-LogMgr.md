...
[Log4j 1.2.x]({{ site.url }}/assets/log/log4j-1.2.17.jar)를 사용할 때

로그파일을 log4j.properties 내에서 정적으로 지정한 것만 사용하는게 불편해서 만들어 본 로그매니저이다.
...
[`LogMgr.java` 코드]({{ site.url }}/assets/log/LogMgr.java)

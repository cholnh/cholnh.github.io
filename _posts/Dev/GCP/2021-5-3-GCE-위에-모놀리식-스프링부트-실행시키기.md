...
- 결제 등록을 마쳤다면 왼쪽 메뉴를 열어 컴퓨팅 카테고리에서 `Compute Engine` 을 선택해 줍니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-sidebar.png"/>
      <div>Compute Engine 선택</div>
    </div>
...
- 위 메뉴에서 `인스턴스 만들기` 를 선택하여 새 인스턴스를 생성해보겠습니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-new-instance.png"/>
      <div>인스턴스 만들기 선택</div>
    </div>
...
- 컨테이너 아래 선택란을 선택해줍니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-vm-2.png"/>
      <div>인스턴스 만들기 폼 작성</div>
    </div>
...
- 아래 폼 마저 작성 후 `만들기` 버튼을 눌러 인스턴스를 생성합니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-vm-3.png"/>
      <div>인스턴스 만들기 폼 작성</div>
    </div>
...
- 생성된 인스턴스를 확인할 수 있습니다.
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-instance-view.png"/>
      <div>인스턴스 생성</div>
    </div>
...
- 연결탭에 SSH 화살표를 누르면 여러 SSH 연결 기능을 살펴볼 수 있습니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-instance-ssh.png"/>
      <div>인스턴스 SSH 연결</div>
    </div>
...
- `브라우저 창에서 열기` 시 간단하게 SSH 연결을 하여 터미널을 사용할 수 있습니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-instance-ssh-view.png"/>
      <div>인스턴스 SSH 브라우저 연결</div>
    </div>  
...
- PuTTYgen 을 통해 key 를 생성합니다.  
    + `Generate` 를 누르면 key 가 생성됩니다.  
        ...
        <div class="nzzi-image-box">
          <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-puttygen-generate.png"/>
          <div>PuTTYgen key 생성</div>
        </div>  
    ...
    + `Save private key` 를 눌러 비밀키를 저장합니다.  
        ...
        <div class="nzzi-image-box">
          <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-puttygen-save.png"/>
          <div>PuTTYgen key 저장</div>
        </div>      
        
    + 위 네모칸에 적힌 공개키 내용을 복사해둡니다.
    
        <div class="nzzi-image-box">
          <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-puttygen-copy.png"/>
          <div>PuTTYgen 공개키 key 복사</div>
        </div>  
...
- puTTY 프로그램을 통해 접속해줍니다.
    + 우선 왼쪽 탭에서 `SSH` - `Auth` 를 선택하고 `Private ket file for authentication` 부분에 비밀키 파일을 등록해줍니다.
        ...
        <div class="nzzi-image-box">
          <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-putty-privatekey.png"/>
          <div>puTTY 비밀키 등록</div>
        </div>  
    
    + 왼쪽 탭 `Session` 으로 돌아와 `Host Name` 에 외부 접속 IP 를 적고 `Open` 을 눌러 접속해줍니다.

        <div class="nzzi-image-box">
          <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-putty-open.png"/>
          <div>puTTY 외부 접속 IP</div>
        </div> 
    
    + 터미널에서 요구하는 로그인정보를 입력해줍니다.

        <div class="nzzi-image-box">
          <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-putty-login.png"/>
          <div>puTTY 로그인</div>
        </div> 
...
- `File` 탭 - `New` - `Project...` 를 선택하여 새 프로젝트를 생성합니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-menu.png"/>
      <div>Spring Initializer 프로젝트 생성</div>
    </div> 
...
- Metadata 를 적어줍니다.
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-metadata.png"/>
      <div>Spring Initializer Metadata</div>
    </div> 
...
- 필요한 Dependency 를 설정해줍니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-dependency-1.png"/>
      <div>Spring Initializer Lombok Dependency</div>
    </div> 
    
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-dependency-2.png"/>
      <div>Spring Initializer Spring Web Dependency</div>
    </div> 
...
- 프로젝트 저장 경로를 설정해줍니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-location.png"/>
      <div>Spring Initializer location</div>
    </div> 
...
- 프로젝트가 빌드되며 Gradle 설정 창이 뜨게됩니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-gradle.png"/>
      <div>Spring Initializer Gradle 설정</div>
    </div> 
...
- Run 메뉴에서 어플리케이션 실행을 시켜봅니다.
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-run.png"/>
      <div>Spring 프로젝트 실행</div>
    </div> 
    
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-springboot-run-console.png"/>
      <div>Spring 프로젝트 실행결과</div>
    </div> 
...
- [Postman 프로그램](https://www.postman.com/downloads/)을 사용하여 API 요청이 잘 반환되는지 확인해볼 수 있습니다.
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-postman.png"/>
      <div>Postman 프로그램을 통한 API 요청 확인</div>
    </div>  
...
- 프로젝트를 실행파일로 build 해줍니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-gradle-build.png"/>
      <div>Gradle build</div>
    </div>  

    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-gradle-build-output.png"/>
      <div>Gradle build output</div>
    </div>  
...
- (로컬)터미널을 열고 scp 명령어를 사용하여 파일을 전송합니다.  
    ...
    <div class="nzzi-image-box">
      <img src="{{ site.url }}/assets/diy/gcp/gce-msa/gcp-scp-output.png"/>
      <div>원격지에 어플리케이션 파일 전송</div>
    </div>      
...
5. 도커 허브에 push 하기  
    ...
    도커 허브 저장소 생성에 관한 내용은 [이곳에]({{ site.url }}/docker/도커.html) 정리해두었습니다.
